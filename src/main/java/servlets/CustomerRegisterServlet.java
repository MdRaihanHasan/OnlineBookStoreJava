    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            if (ResponseCode.SUCCESS.name().equalsIgnoreCase(respCode)) {
                ...
                rd.include(req, res);
                pw.println("<table style=\"margin-top: 20px;\" class=\"tab\"><tr><td style='color: green;'>User Registered Successfully</td></tr></table>");
            } else {
                RequestDispatcher rd = req.getRequestDispatcher("CustomerRegister.html");
                rd.include(req, res);
                pw.println("<table style=\"margin-top: 20px;\" class=\"tab\"><tr><td style='color: red;'>" + respCode + "</td></tr></table>");
                pw.println("<p style='color: red;'>Sorry for interruption! Try again</p>");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
