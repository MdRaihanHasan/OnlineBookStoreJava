...
public class CartServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            pw.println("<div id='topmid' class=\"container\">Shopping Cart</div>");
            pw.println("<table class=\"table table-hover container\" style='background-color:white'>\r\n"
                    + "  <thead>\r\n"
            ...
            if (amountToPay > 0) {
                pw.println("<div  class=\"container\">\r\n"
                        ...
                        + "<input style='margin-left: 5px;' type='submit' class=\"btn btn-primary\" name='pay' value='Proceed to Pay &#36; "
                        + amountToPay + "'/></form>"
                        + "    </div>");
            }
        } catch (Exception e) {
